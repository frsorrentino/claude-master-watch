...
export const RemotionRoot: React.FC = () => (
  <>
    ...
    <Composition id="Short" component={ShortFilm} defaultProps={{ stems: "all" as const, blur: true, shape: { from: 0 } as ShapeSpan | null, effects: { shadow: true, ripple: true, light: true } }} fps={30} width={1920} height={1080} durationInFrames={framesOf(SHORT_TIMELINE)} />
