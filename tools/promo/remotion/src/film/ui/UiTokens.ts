...
export const UI = {
  ...
  badge: "#3C81F2",
  briefRing: "#8BB4F7", briefWeek: "#B9A6F5", briefTrack: "#455165",   // anelli della quota: 5 ore, settimana, binario            // il blu dell'account nel badge della card (misurato sul fotogramma della lista)
};
