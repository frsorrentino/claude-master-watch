 ...
 */
export const Blink: React.FC<{ word: string; cut: number }> = ({ word, cut }) => {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
      {b.word ? (
        ...
        <div style={{ position: "absolute", left: THEME.leftMargin, top: height / 2 + THEME.title * 0.5, transformOrigin: "0 50%", scale: String(b.scale), translate: "0 -50%", fontFamily: "Inter", fontWeight: 600, fontSize: THEME.title, lineHeight: 1.04, letterSpacing: "-0.02em", color: THEME.accent, whiteSpace: "nowrap" }}>{word}</div>
      ) : null}
