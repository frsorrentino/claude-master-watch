...
export type Fx =
  ...
  | { kind: "aside"; at: number; len: number; fadeIn?: number; draw?: number; panel: "quota" | "note" | "pace" | "work" | "questions" | "context"; n?: number; note?: string; quote?: string; lines?: string[]; bars?: number[]; rows?: { name: string; pct: number; week?: number }[]; out?: "bars" | "curtain" }   // il dato della Panoramica compare fermo a sinistra e si anima sul posto; `out: "bars"`: le sue barre diventano il passaggio alla scena dopo
