...
export const END_PACE: Record<EndPace, { start: number; sub: number; repo: number; notes: number }> = {
  ...
  // dopo la tapparella (corto, 23/09): il nome arriva quando il logo si è posato sull'orologio (Franz, 18:55), non sopra
  // l'arco grande; gli avvisi restano 2,5 battiti su 8
  blinds: { start: 4, sub: 0.5, repo: 1, notes: 1.5 },
};
