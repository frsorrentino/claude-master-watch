...
import { DoneCard } from "./ui/DoneCard.tsx";
...
export const fxLayers = (scene: Scene, g: Grid, _prev?: Scene): { overlay: React.ReactNode; around: React.ReactNode } => {
  ...
  return {
    overlay: fx.map((e, i) =>
      ...
      : e.kind === "doneCard" ? <Sequence key={i} from={at(e.at)} layout="none"><DoneCard name={e.name} age={e.age} text={e.text} badge={e.badge} beat={spanFrames(g, scene.at + e.at, 1)} rest={e.rest} /></Sequence>
