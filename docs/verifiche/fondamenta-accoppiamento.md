...
| A8 | Con «riduci animazioni» niente movimento, tutto al suo stato finale | impostazioni di accessibilità del telefono | ✅ 25/09 12:26, animazioni a 0 via adb (`animator_duration_scale`, `transition_animation_scale`, `window_animation_scale`) prima della scansione: i tre passi compaiono fermi, allo stato finale, confermato da Franz alle 12:41 |
