...
| # | Cosa | Come | Esito |
|---|------|------|-------|
| 1 | Esito: il ▶ legge solo la frase d'esito, il titolo | Scheda, Esito, ▶ | |
| 2 | Terminale: il ▶ accanto al nome legge gli ultimi tre blocchi sopra il prompt, senza comandi di shell né statusline | Scheda, Terminale, ▶ | |
...
Lint vital: ✅ in CI sul codice installato (`586a9bd`, run 34847845524, `:wear:lintVitalRelease`, BUILD SUCCESSFUL
13:19 UTC; prima su `03d4305`, run 34844107945). In locale non gira: `lintVitalAnalyzeRelease` si blocca oltre 10 minuti sulla VM da 6 GB.
