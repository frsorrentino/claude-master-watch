...
| 5 | Testi lunghi scorrono dopo 2 s, tre giri, poi fermi | `cmMarquee`, solo la riga al centro | in parte: il nome della riga al centro scorre (catture adb 14/09 20:18, «review-2026-09»); attesa di 2 s e tre giri da vedere al polso |
